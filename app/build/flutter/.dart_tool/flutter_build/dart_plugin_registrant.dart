...
import 'package:serious_python_android/serious_python_android.dart' as serious_python_android;
...
import 'package:serious_python_darwin/serious_python_darwin.dart' as serious_python_darwin;
...
import 'package:serious_python_linux/serious_python_linux.dart' as serious_python_linux;
...
import 'package:serious_python_windows/serious_python_windows.dart' as serious_python_windows;
import 'package:share_plus/share_plus.dart' as share_plus;
...
class _PluginRegistrant {
  ...
  static void register() {
    if (Platform.isAndroid) {
      ...
      try {
        serious_python_android.SeriousPythonAndroid.registerWith();
      } catch (err) {
        print(
          '`serious_python_android` threw an error: $err. '
          'The app may not function as expected until you remove this plugin from pubspec.yaml'
        );
      }
      ...
      try {
        serious_python_darwin.SeriousPythonDarwin.registerWith();
      } catch (err) {
        print(
          '`serious_python_darwin` threw an error: $err. '
          'The app may not function as expected until you remove this plugin from pubspec.yaml'
        );
      }
      ...
      try {
        serious_python_linux.SeriousPythonLinux.registerWith();
      } catch (err) {
        print(
          '`serious_python_linux` threw an error: $err. '
          'The app may not function as expected until you remove this plugin from pubspec.yaml'
        );
      }
      ...
      try {
        serious_python_windows.SeriousPythonWindows.registerWith();
      } catch (err) {
        print(
          '`serious_python_windows` threw an error: $err. '
          'The app may not function as expected until you remove this plugin from pubspec.yaml'
        );
      }
