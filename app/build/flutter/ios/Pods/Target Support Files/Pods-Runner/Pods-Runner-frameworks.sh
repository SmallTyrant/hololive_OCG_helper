...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/serious_python_darwin/serious_python_darwin.framework"
...
PYTHON_XCFRAMEWORKS_ROOT="/Users/perlihite/Desktop/hololive_OCG_helper/app/build/flutter/ios/Pods/../.symlinks/plugins/serious_python_darwin/darwin/dist_ios/site-xcframeworks"
