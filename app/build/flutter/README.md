...
* `hocg_h` - project name - lowercase, no spaces, i.e. "snake_case" identifier - used as a package name, iOS/macOS/Android bundle name and Windows/Linux executable file name.
* `` - project description.
* `hOCG_H` - project display name that is shown in window titles and about app dialogs.
* `com.smalltyrant` - org name in reverse domain name notation, e.g. `com.mycompany.myproject`.
